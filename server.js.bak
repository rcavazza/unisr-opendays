            ...
            try {
                ...
                if (associationsResponse.data.results && associationsResponse.data.results.length > 0) {
                    ...
                    try {
                        ...
                        // Redirect to the selection page with the location parameter
                        res.redirect(`/selection?contactID=${contact.id}&lang=${language}&location=${encodeURIComponent(location)}`);
