/**
 * Script di test per verificare che gli slot prenotati vengano correttamente marcati come selezionati
 * nella risposta dell'endpoint /api/get_experiences
 */
...
async function testSlotSelection() {
    try {
        console.log('Inizio test di selezione degli slot...');
