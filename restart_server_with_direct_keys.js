/**
 * Script to restart the server with the direct database keys implementation
 */
const { exec } = require('child_process');
const path = require('path');

console.log('Restarting server with direct database keys implementation...');
...
function startServer() {
  ...
  setTimeout(() => {
    ...
    exec('node test_api_slots.js', (error, stdout) => {
      ...
      console.log(stdout);
      console.log('\nServer restart complete. The API is now using the direct database keys format.');
    });
