...
async function testEndpoint() {
  try {
    ...
    const enResponse = await axios.get('http://localhost:3000/api/get_experiences?contactID=12345&lang=en');
    ...
    const itResponse = await axios.get('http://localhost:3000/api/get_experiences?contactID=12345&lang=it');
